    ...
    <section id="top" className="bg-suis-cream pb-4 pt-2 md:pb-0 md:pt-4">
      <div className="mx-auto max-w-6xl px-5 md:px-8">
        ...
        <div className="mb-4 hidden items-center justify-between border-b border-suis-stone pb-3 text-[11px] uppercase tracking-[0.18em] text-suis-muted md:flex">
          <span>Desserts &amp; drinks, made fresh</span>
        ...
        <div className="relative">
          ...
          <div className="relative z-10 -mt-10 grid gap-px overflow-hidden bg-suis-stone shadow-[0_12px_40px_rgba(33,68,192,0.10)] sm:grid-cols-2 md:-mt-16 md:mx-auto md:w-[86%]">
            <div className="bg-suis-cream px-6 py-7 md:px-8 md:py-9">
              <h1 className="font-display text-2xl uppercase tracking-[0.06em] text-suis-blue md:text-3xl">
                Suis &mdash; Sip &amp; Savour
              </h1>
              ...
              <a
                href="#menu"
                className="mt-5 inline-block rounded-full bg-suis-blue px-6 py-2.5 font-display text-xs uppercase tracking-[0.14em] text-white transition-opacity hover:opacity-90"
              >
                See the Menu
              </a>
            </div>
            ...
            <div className="bg-suis-cream px-6 py-7 md:px-8 md:py-9">
              ...
              <a
                ...
                className="mt-5 inline-block rounded-full bg-suis-yellow px-6 py-2.5 font-display text-xs uppercase tracking-[0.14em] text-suis-ink transition-opacity hover:opacity-90"
              >
                Find Us Next
              </a>
            </div>
